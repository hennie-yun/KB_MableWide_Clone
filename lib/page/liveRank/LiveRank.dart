...
import 'package:sm_mdi/manager/MenuManager.dart';
import 'package:sm_mdi/page/liveRank/LiveChart.dart';

class LiveRank extends StatelessWidget {
  @override
                  ...
                  Expanded(
                      ...
                      child: Container(
                          ...
                          child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                subTitle(context, "많이 오른"),
                                SizedBox(height: 10),
                                increase("1", "assets/images/jm2.png", "제주맥주",
                                    "+", "5,210원", "1,115원", "(27.92%)"),
                                increase(
                                    "2",
                                    ...
                                    "1,115원",
                                    "(27.92%)"),
                                increase("3", "assets/images/jm4.png", "디티엔씨알오",
                                    "+", "5,210원", "1,115원", "(27.92%)"),
                                increase("4", "assets/images/jm3.png", "나라셀라",
                                    "+", "5,210원", "1,115원", "(27.92%)"),
                                increase(
                                    "5",
                  ...
                  Expanded(
                      ...
                      child: Container(
                          ...
                          child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                subTitle(context, "거래 대금"),
                                SizedBox(height: 10),
                                increase("1", "assets/images/jm_1.png", "태평양물산",
                                    "+", "5,210원", "1,115원", "(27.92%)"),
                                increase(
                                    "2",
                                    "assets/images/jm7.png",
                                    "에스와이스틸텍",
                                    "+",
                                    "5,210원",
                                    "1,115원",
                      ...
                      child: Expanded(
                          ...
                          child: Container(
                              ...
                              child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    subTitle(context, "많이 내린"),
                                    SizedBox(height: 10),
                                    increase("1", "assets/images/jm1.png", "협진",
                                        "-", "5,210원", "1,115원", "(27.92%)"),
                                    increase(
                                        "2",
  ...
  Widget title(String title) {
    return InkWell(
        onTap: () {
          MenuManager.instance.movePage(LiveChart(initialTabIndex: 0));
        },
        child: Container(
            height: 36,
    ...
    return  InkWell(
        ...
        switch(title) {
          case "많이 오른":
            ...
            break;
          case "거래 대금":
            MenuManager.instance.movePage(LiveChart(initialTabIndex:2));
            break;
          case "많이 내린":
            MenuManager.instance.movePage(LiveChart(initialTabIndex:1));
            break;
